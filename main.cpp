     ...
     for (int i = 0; i < (sizeof(blockSize) / sizeof(int)); i++)
     {
          ...
          if (file.is_open())
          {
               ...
               while (getline(file, line))
               {
                    ...
                    location = diskStorage.insertRecord(recordSize);
